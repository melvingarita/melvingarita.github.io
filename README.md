...
<head>
  ...
  https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;800;900&family=Plus+Jakarta+Sans:wght@700;800&display=swap
...
<body>
  <!-- Skip link -->
  #contenidoSaltar al contenido</a>

  <!-- ======= Header / Nav ======= -->
  <header class="site-header">
    <div class="container topnav">
      <!-- Brand ahora es link -->
      /home/Melvin Garita</a>

      <nav class="mainnav" aria-label="Navegación principal">
        <ul>
          <li>/home/Inicio</a></li>
          <li>/logros/Logros</a></li>
          <li>/enfoque/Enfoque</a></li>
          <li>https://www.linkedin.com/in/melvingaritaContacto</a></li>
        </ul>
      </nav>
    </div>
    ...
    <div class="container hero" aria-labelledby="titulo-hero" aria-describedby="desc-hero">
      ...
      <div class="hero-actions" role="group" aria-label="Acciones principales">
        ...
        https://www.linkedin.com/in/melvingarita
  ...
  <main id="contenido" class="container">
    ...
    <section aria-labelledby="contacto" id="contacto">
      ...
      <p>
        ...
        https://www.linkedin.com/in/melvingaritaLinkedIn</a>
        · mailto:melvin.garita@gmail.comContáctame</a>
      </p>
    </section>
  </main>
