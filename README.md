...
<head>
  ...
  <meta name="description"
        content="Estrategia, Excelencia Organizacional, Analítica e Inteligencia Artificial aplicada a la banca. Más de 20 años liderando ejecución estratégica, transformación, eficiencia operativa y analítica avanzada."
        data-i18n-attr="content:seo.description" />
  <meta name="robots" content="index,follow,max-image-preview:large" />

  <!-- Canonical (se setea dinámicamente por JS) -->
  ...
  <style>
    :root{
      ...
      --radius-xl:18px; --radius-lg:14px; --radius-md:12px; --container:1120px;
      --focus-outline: 2px solid rgba(14,165,233,.65);
      --focus-offset: 3px;
    }
    ...
    *{ box-sizing:border-box }
    ...
    .brand{
      font-weight:800; letter-spacing:.03em; font-family:"Plus Jakarta Sans", Inter, system-ui, sans-serif;
    ...
    @media (prefers-color-scheme: dark){
      ...
      .mainnav a[aria-current="page"]{ background:rgba(14,165,233,.18); color:#a7e3ff }
    }
    ...
    .hero h1{
      margin:14px 0 10px; font-family:"Plus Jakarta Sans", Inter, system-ui, sans-serif;
    ...
    .btn{
      --_bg:#0f172a; --_fg:#e5eefb; --_bd:rgba(255,255,255,.14);
      display:inline-flex; align-items:center; gap:10px; padding:12px 16px;
      border-radius:12px; border:1px solid var(--_bd); background:var(--_bg); color:var(--_fg);
      text-decoration:none; font-weight:700; transition:transform .08s ease, background .25s ease, border-color .25s ease, color .25s ease
    }
...
<body>
  ...
  <header class="site-header">
    <div class="container topnav">
      <!-- Brand ahora es link -->
      <a class="brand" href="/home/" data-i18n="brand.name">Melvin Garita</a>

      <nav class="mainnav" aria-label="Navegación principal">
        <ul>
          <li><a href="/home/" data-i18n="nav.home">Inicio</a></li>
          <li><a href="/logros/" data-i18n="nav.achievements">Logros</a></li>
          <li><a href="/enfoque/" data-i18n="nav.approach">Enfoque</a></li>
          <li><a href="https://www.linkedin.com/in/melvingarita" target="_blank" rel="noopener noreferrer me" data-i18n="nav.contact">Contacto</a></li>
        </ul>
      </nav>
    </div>
    ...
    <div class="container hero" aria-labelledby="titulo-hero" aria-describedby="desc-hero">
      <!-- H1 sin HTML embebido en traducción -->
      <h1 id="titulo-hero">
        <span data-i18n="hero.title.line1">Estrategia, Excelencia Organizacional, Analítica e Inteligencia Artificial</span><br>
        <span data-i18n="hero.title.line2">aplicada a la banca</span>
      </h1>
      ...
      <div class="hero-actions" role="group" aria-label="Acciones principales">
        <a class="btn btn-primary" href="/cv/" target="_blank" rel="noopener noreferrer" data-i18n="cta.cv">
          Ver Curriculum Vitae
        </a>

        <a class="btn btn-ghost" href="https://www.linkedin.com/in/melvingarita" target="_blank" rel="noopener noreferrer me" data-i18n="cta.linkedin">
  ...
  <main id="contenido" class="container">
      ...
      <ul class="grid">
        <li>
          <article class="card" aria-labelledby="card1-title" aria-describedby="card1-desc">
            ...
            <h3 id="card1-title">
              <span data-i18n="cards.strategy.title">Estrategia</span>
              <span class="muted" data-i18n="cards.strategy.title2">Empresarial</span>
            </h3>
            <p id="card1-desc" data-i18n="cards.strategy.body">
              Revisión de modelos de negocio y KPIs; adopción de marcos ágiles a nivel empresarial.
            </p>
          </article>
        </li>
          ...
          <article class="card" aria-labelledby="card2-title" aria-describedby="card2-desc">
            <div class="eyebrow">
              <span class="badge badge-green" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path d="M4 13c4 0 4-6 8-6s4 12 8 12" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                </svg>
              </span>
              <span data-i18n="cards.optimization.eyebrow">Optimización</span>
            </div>
            <h3 id="card2-title">
              <span data-i18n="cards.optimization.title">Optimización de costos</span>
              <span class="muted" data-i18n="cards.optimization.title2">financieros y operativos</span>
            </h3>
            <p id="card2-desc" data-i18n="cards.optimization.body">
              Implementación de soluciones de IA en servicio al cliente, elevando eficiencia y calidad.
            </p>
          </article>
        </li>
          ...
          <article class="card" aria-labelledby="card3-title" aria-describedby="card3-desc">
            <div class="eyebrow">
              <span class="badge badge-amber" aria-hidden="true">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path d="m12 17 5.196 3.09-1.381-5.927L20.39 9.91l-6.045-.51L12 3.9 9.655 9.4l-6.046.51 4.575 4.253-1.381 5.927L12 17Z"
            ...
            <h3 id="card3-title">
              <span data-i18n="cards.excellence.title">Excelencia</span>
              <span class="muted" data-i18n="cards.excellence.title2">Organizacional</span>
            </h3>
            <p id="card3-desc" data-i18n="cards.excellence.body">
              Premio Nacional a la Excelencia (2020) y reconocimientos internacionales en ejecución estratégica.
            </p>
          </article>
        </li>
      </ul>
    ...
    <section aria-labelledby="contacto" id="contacto">
      <h2 class="section-title" id="contactoTitle" data-i18n="sections.contact">CONTACTO</h2>
      <p>
        <span data-i18n="contact.text">¿Conversamos?</span>
        <a href="https://www.linkedin.com/in/melvingarita" target="_blank" rel="noopener noreferrer me" data-i18n="contact.linkedin">LinkedIn</a>
  ...
  <footer class="container">
    © <span id="year"></span> <span data-i18n="brand.name">Melvin Garita</span> —
    <span data-i18n="footer.keywords">Estrategia | Excelencia Organizacional | Analítica/IA</span>
  </footer>
  ...
  <script>
    ...
    function buildAbsoluteUrl(pathOrUrl) {
      // Si ya es absoluta, la deja; si es relativa, la vuelve absoluta con origin
      try {
    ...
    // ====== Diccionario (sin HTML embebido; sin &amp; en JSON)
    const DICT = {
      es: {
        "brand.name": "Melvin Garita",
        ...
        "hero.title.line1": "Estrategia, Excelencia Organizacional, Analítica e Inteligencia Artificial",
        "hero.title.line2": "aplicada a la banca",
      ...
      en: {
        ...
        "hero.title.line1": "Strategy, Organizational Excellence, Analytics and Artificial Intelligence",
        "hero.title.line2": "for Banking",
    ...
    // ====== Aplicador i18n (solo textContent y setAttribute)
    function applyI18n(lang = 'es') {
      ...
      document.querySelectorAll('[data-i18n-attr]').forEach(el => {
        ...
        raw.split('|').map(s => s.trim()).filter(Boolean).forEach(def => {
      ...
      // 5) JSON-LD actualizado por idioma
    ...
    // ====== Canonical + OG/Twitter URLs dinámicas
    function applyDynamicUrls() {
      const currentUrl = location.href.split('#')[0];
      setLinkHref('canonicalLink', currentUrl);
      document.getElementById('ogUrl')?.setAttribute('content', currentUrl);

      // Imagen OG/Twitter: ajusta el path según tu archivo real
      const ogImg = buildAbsoluteUrl('/og-image.jpg'); // súbelo a la raíz del repo si puedes
    ...
    // ====== aria-current por URL (sin click handlers)
    function markActiveNav() {
      ...
      document.querySelectorAll('.mainnav a').forEach(a => {
        ...
        try {
          ...
          const isActive = (target !== '/' && current.startsWith(target)) || (target === '/' && current === '/');
